...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-5 sm:px-8 h-14 flex items-center justify-between gap-6">
        {/* Logo */}
        <Link
          href="/"
          className="shrink-0 font-black text-sm tracking-[0.3em] text-white/90 hover:text-white transition-colors"
        >
          WEINOZ
        </Link>
