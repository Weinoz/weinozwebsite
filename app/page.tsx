...
const socialPlatforms = [
  {
    name: 'YouTube',
    handle: '@weinoz',
    href: 'https://www.youtube.com/@weinoz',
    icon: YoutubeIcon,
    desc: 'Vidéos gaming & vlogs',
  },
  {
    name: 'Twitch',
    handle: 'weinoz',
  ...
  },
  {
    name: 'TikTok',
    handle: '@weinoz',
    href: 'https://www.tiktok.com/@weinoz',
    icon: TikTokIcon,
  ...
  },
  {
    name: 'Instagram',
    handle: '@weinoz_',
    href: 'https://www.instagram.com/weinoz_/',
    icon: InstagramIcon,
    desc: 'Photos & stories',
  },
  {
  ...
  },
  {
    name: 'Discord',
    handle: 'Rejoindre',
    href: 'https://discord.gg/uBG6UDX56a',
    icon: DiscordIcon,
    desc: 'La communauté',
  },
];
...
export default function HomePage() {
  return (
    <>
      {/* ── HERO ── bright purple gradient like reference */}
      <section
        style={{
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 w-full">
          {/* Tag */}
          <p
            className="section-label mb-6 anim-fade-in"
            style={{ color: 'rgba(255,255,255,0.5)', animationDelay: '0s' }}
          >
            gaming &amp; bonne humeur 🧦
          </p>
      ...
      <section style={{ background: '#0E0018', padding: '5rem 0' }}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '2.5rem' }}>
            ...
            <Link
              href="/videos"
              style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.8rem', fontWeight: 600, color: 'rgba(160,32,240,0.8)', whiteSpace: 'nowrap' }}
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '2.5rem' }}>
            <div>
              ...
              <p style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.3)', marginTop: '0.4rem' }}>
                {games.length} jeux · {completedCount} terminés
              </p>
            </div>
            <Link
              href="/jeux"
